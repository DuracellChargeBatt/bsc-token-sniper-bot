...
# BSC/EVM Token Sniper Frontrunning MEV Bot for Pancakeswap

A semi profitable launch token sniper bot for EVM-based chains (BSC, ETH, AVAX, MATIC, FTM, CRO, Harmony, Milkomeda, Moonforce, etc). Monitors the mempool for new token launches and liquidity events. Use at your own risk.
...
A: I managed to turn 0.1 BNB into 1 BNB in under 1 day, however your results maybe different. You may make more than when I first tested this tool.
